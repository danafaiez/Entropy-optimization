...
for i in range(1,5):
       ...
       plt.errorbar(N[i-1],R_mean, yerr=np.array([[R_mean-R_min ,R_max-R_mean]]).T,fmt='g*',elinewidth=0.6,
...
for i in range(1,5):
       ...
       plt.errorbar(N[i-1],R_mean, yerr=np.array([[R_mean-R_min ,R_max-R_mean]]).T,fmt='m*',elinewidth=0.6,
