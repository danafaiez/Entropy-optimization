...
#Probability of localizing 3 particles in the middle 5 sites is maximized using unitary.c, 100 times, each time starting with a different random set of complex gaussian coefficients
...
Y[3] = 'Pmax_L30_Ne3_bath5_complG_locmid_B0.01.d'
Y[2] = 'Pmax_L25_Ne3_bath5_complG_locmid_B0.01.d'
Y[1] = 'Pmax_L15_Ne3_bath5_complG_locmid_B0.01.d'

S[3] = 'Smin_L30_Ne3_bath5_complG_locmid_B0.01.d'
S[2] = 'Smin_L25_Ne3_bath5_complG_locmid_B0.01.d'
S[1] = 'Smin_L15_Ne3_bath5_complG_locmid_B0.01.d'
...
plt.legend()
plt.title('P maxed in middle 5 sites_cmplx Gaussian coeff__N=3_B=0.01')
x=[1,2,3]
x_label=[15,25,30]
