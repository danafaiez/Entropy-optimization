...
#Probability of localizing 3 particles in the middle 5 sites is maximized using unitary.c, 100 times, each time starting with a different random set of real gaussian coefficients
...
Y = [None]*4
S = [None]*4
Y[3] = np.loadtxt('Pmax_L30_Ne3_bath5_realG_locmid_B0.01.d')
Y[2] = np.loadtxt('Pmax_L25_Ne3_bath5_realG_locmid_B0.01.d')
Y[1] = np.loadtxt('Pmax_L15_Ne3_bath5_realG_locmid_B0.01.d')

S[3] = np.loadtxt('Smin_L30_Ne3_bath5_realG_locmid_B0.01.d')
S[2] = np.loadtxt('Smin_L25_Ne3_bath5_realG_locmid_B0.01.d')
S[1] = np.loadtxt('Smin_L15_Ne3_bath5_realG_locmid_B0.01.d')

Save= [5.6554212,7.2866015,7.8575661]
...
plt.legend()
plt.title('P maxed in middle 5 sites_real Gaussian coeff__N=3_B=0.01')
x=[1,2,3]
x_label=[15,25,30]
